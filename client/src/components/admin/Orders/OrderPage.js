                    ...
                    return (
                      <div key={index} style={{ margin: "10px auto" }} className="theme-background-6 w-100 padding-m border-radius-s">
                        ...
                        <div style={{ marginTop: "30px" }}>
                          ...
                          {item.varietal && 'size' in item.varietal && item.varietal.size !== null && <div><span className="bold">Size:</span> {item.varietal.size.value}</div>}
                          {item.varietal && 'color' in item.varietal && item.varietal.color !== null && <div><span className="bold">Color:</span> {item.varietal.color.name}</div>}
