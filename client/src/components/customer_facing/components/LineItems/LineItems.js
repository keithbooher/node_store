                ...
                <div className="line_item_sub_container">
                  ...
                  <div className="flex">
                    ...
                    <div className="padding-s flex flex_column space-evenly">
                      ...
                      {line_item.varietal && line_item.varietal.size !== null && <div><span >Size:</span> {line_item.varietal.size.value}</div>}
                      {line_item.varietal && line_item.varietal.color !== null && <div><span >Color:</span> {line_item.varietal.color.name}</div>}
