...
class Reviews extends Component {
  ...
  async componentDidMount() {
    const reviews = await API.getUsersReviews(this.props.auth._id)
    ...
    return this.state.reviews.map((review) => {
      return (
        <div className="border margin-m-v">
          ...
          <div className="clickable" onClick={() => this.getOrder(review._order_id, review.line_item._id)}>order</div>
